...
describe("참거짓", function () {
  ...
  it("분기", function () {
    ...
    assertInterpret(
      "1을 '변수'라고 하고 1이면 1 2가 아니면 3 아니면 0과 10의 합.",
      11
    );
    assertInterpret(
      "2를 '변수'라고 하고 1이면 1 2가 아니면 3 아니면 0과 10의 합.",
      10
    );

    assertInterpret(
      "4를 '변수'라고 하고 1이면 1 2가 아니면 3 아니면 0과 10의 합.",
      13
    );
    assertInterpret(
      "4를 '변수'라고 하고 1이면 1, 2가 아니면 3 아니면 0과 10의 합.",
...
describe("명령형", function () {
  ...
  it("반복", function () {
    ...
    defs = `
      0을 '지표'로 삼고 2를 '결과'라고 하자.
      '지표'가 5와 같을 때까지,
        '결과'의 제곱을 '결과'로 삼고 '지표'와 1의 합을 '지표'로 하자.`;
